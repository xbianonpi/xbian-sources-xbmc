...
if(PLATFORM STREQUAL "raspberry-pi" OR ENABLE_MMAL) # **M**
...
if(MMAL_FOUND)
  ...
  if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
    ...
    set_target_properties(${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME} PROPERTIES
                                     IMPORTED_LOCATION "${MMAL_LIBRARY}"
                                     INTERFACE_COMPILE_DEFINITIONS "HAVE_MMAL;HAS_MMAL"
                                     INTERFACE_INCLUDE_DIRECTORIES "${MMAL_INCLUDE_DIR}")
    list(APPEND DEPLIBS ${MMAL_LIBRARIES})   
