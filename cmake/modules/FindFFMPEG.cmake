...
macro(buildFFMPEG)
  ...
  if(CORE_PLATFORM_NAME STREQUAL rbpi OR USE_PLATFORM MATCHES "raspberry")
    ...
    if(CORE_PLATFORM_NAME STREQUAL rbpi)
      ...
      set (FFMPEG_PATCH_0 ${CMAKE_SOURCE_DIR}/tools/depends/target/ffmpeg/0001-rpi-Add-hevc-acceleration-7.1.patch)
      set (FFMPEG_PATCH_2 ${CMAKE_SOURCE_DIR}/tools/depends/target/ffmpeg/0001-ffmpeg-Call-get_format-to-fix-an-issue-with-MMAL-ren-6.0-7.1.patch)
    ...
    set (FFMPEG_PATCH_0 ${CMAKE_SOURCE_DIR}/tools/depends/target/ffmpeg/added_upstream_mvc_patches-7.1.patch)
