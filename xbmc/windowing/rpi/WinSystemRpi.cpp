                                    ...
                                    RESOLUTION_INFO& res)
{
  ...
  if (delay > 0)
  {
    ...
    m_dispResetTimer.Set(std::chrono::milliseconds(static_cast<int>(delay * 100)));
  }
...
void CWinSystemRpi::UpdateResolutions()
{
  ...
  for (size_t i = 0; i < resolutions.size(); i++)
  {
    ...
    CLog::Log(LOGINFO, "Found resolution {} x {} with {} x {}{} @ {:f} Hz", resolutions[i].iWidth,
  ...
  {
    CLog::Log(LOGINFO, "Found ({}x{}{}@{:f}) at {}, setting to RES_DESKTOP at {}", resDesktop.iWidth,
