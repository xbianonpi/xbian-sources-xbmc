...
{
  const static double maxChange = 1.0065;
  ...
  double ret = 0.44 * error / 1000 + 0.37 * derivative + 0.0012 * m_resampleIntegral;
  ...
  CLog::Log(LOGAUDIO,"----- error: %12f/%12f, rr: %12f, de: %12f, int: %12f",
