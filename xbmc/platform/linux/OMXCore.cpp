...
OMX_ERRORTYPE COMXCoreTunnel::Deestablish(bool noWait)
{
  ...
  if(m_src_component->GetComponent())
  {
    ...
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Deestablish - Error disable port {} on component {} omx_err(0x{:08x})",
  ...
  if(m_src_component->GetComponent())
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Deestablish - Error WaitForCommand port {} on component {} omx_err(0x{:08x})",
  ...
  if(m_src_component->GetComponent())
  {
    ...
    {
      CLog::Log(LOGERROR,
                "COMXCoreTunnel::Deestablish - could not unset tunnel on comp src {} port {} "
                "omx_err(0x{:08x})",
  ...
  if(m_dst_component->GetComponent())
  {
    ...
    {
      CLog::Log(LOGERROR,
                "COMXCoreTunnel::Deestablish - could not unset tunnel on comp dst {} port {} "
                "omx_err(0x{:08x})",
...
OMX_ERRORTYPE COMXCoreTunnel::Establish(bool enable_ports /* = true */, bool disable_ports /* = false */)
{
  ...
  if(m_src_component->GetState() == OMX_StateLoaded)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Establish - Error setting state to idle {} omx_err(0x{:08x})",
  ...
  if(m_src_component->GetComponent() && disable_ports)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Establish - Error disable port {} on component {} omx_err(0x{:08x})",
          m_src_port, m_src_component->GetName().c_str(), (int)omx_err);
    }
  }
  ...
  if(m_src_component->GetComponent() && disable_ports)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Establish - Error WaitForCommand port {} on component {} omx_err(0x{:08x})",
          m_dst_port, m_src_component->GetName().c_str(), (int)omx_err);
      return omx_err;
    }
  }
  ...
  if(m_src_component->GetComponent() && m_dst_component->GetComponent())
  {
    ...
    {
      CLog::Log(LOGERROR,
                "COMXCoreTunnel::Establish - could not setup tunnel src {} port {} dst {} port {} "
                "omx_err(0x{:08x})",
  ...
  if(m_src_component->GetComponent() && enable_ports)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreTunnel::Establish - Error enable port {} on component {} omx_err(0x{:08x})",
          m_src_port, m_src_component->GetName().c_str(), (int)omx_err);
      return omx_err;
    }
  }
  ...
  if(m_dst_component->GetComponent() && enable_ports)
  {
    ...
    if(m_dst_component->GetState() == OMX_StateLoaded)
    {
      ...
      if(omx_err != OMX_ErrorNone)
      {
        CLog::Log(LOGERROR, "COMXCoreComponent::Establish - Error setting state to idle {} omx_err(0x{:08x})",
            m_src_component->GetName().c_str(), (int)omx_err);
        return omx_err;
      }
    }
...
OMX_ERRORTYPE COMXCoreComponent::EmptyThisBuffer(OMX_BUFFERHEADERTYPE *omx_buffer)
{
  ...
  CLog::Log(LOGDEBUG, "COMXCoreComponent::EmptyThisBuffer component({}) {:p}",
  ...
  {
    CLog::Log(LOGERROR,
              "COMXCoreComponent::EmptyThisBuffer component({}) - failed with result(0x{:x})",
...
OMX_ERRORTYPE COMXCoreComponent::FillThisBuffer(OMX_BUFFERHEADERTYPE *omx_buffer)
{
  ...
  #if defined(OMX_DEBUG_EVENTHANDLER)
  CLog::Log(LOGDEBUG, "COMXCoreComponent::FillThisBuffer component({}) {:p}", m_componentName.c_str(),
            omx_buffer);
#endif
  if(!m_handle || !omx_buffer)
    return OMX_ErrorUndefined;
  ...
  {
    CLog::Log(LOGERROR,
              "COMXCoreComponent::FillThisBuffer component({}) - failed with result(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
...
OMX_ERRORTYPE COMXCoreComponent::FreeOutputBuffer(OMX_BUFFERHEADERTYPE *omx_buffer)
{
  ...
  {
    CLog::Log(LOGERROR,
              "COMXCoreComponent::FreeOutputBuffer component({}) - failed with result(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
...
void COMXCoreComponent::FlushInput()
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::FlushInput - Error on component {} omx_err(0x{:08x})",
...
void COMXCoreComponent::FlushOutput()
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::FlushOutput - Error on component {} omx_err(0x{:08x})",
              m_componentName.c_str(), (int)omx_err);
  }
...
OMX_BUFFERHEADERTYPE *COMXCoreComponent::GetInputBuffer(long timeout /*=200*/)
{
  ...
  while (!m_flush_input)
  {
    ...
    if (retcode != 0) {
      if (timeout != 0)
        CLog::Log(LOGERROR, "COMXCoreComponent::GetInputBuffer {} wait event timeout",
...
OMX_BUFFERHEADERTYPE *COMXCoreComponent::GetOutputBuffer(long timeout /*=200*/)
{
  ...
  while (!m_flush_output)
  {
    ...
    if (retcode != 0) {
      CLog::Log(LOGERROR, "COMXCoreComponent::GetOutputBuffer {} wait event timeout",
                m_componentName.c_str());
      break;
    }
  }
...
OMX_ERRORTYPE COMXCoreComponent::WaitForInputDone(long timeout /*=200*/)
{
  ...
  while (m_input_buffer_count != m_omx_input_available.size())
  {
    ...
    if (retcode != 0) {
      if (timeout != 0)
        CLog::Log(LOGERROR, "COMXCoreComponent::WaitForInputDone {} wait event timeout",
                  m_componentName.c_str());
...
OMX_ERRORTYPE COMXCoreComponent::WaitForOutputDone(long timeout /*=200*/)
{
  ...
  while (m_output_buffer_count != m_omx_output_available.size())
  {
    ...
    if (retcode != 0) {
      if (timeout != 0)
        CLog::Log(LOGERROR, "COMXCoreComponent::WaitForOutputDone {} wait event timeout",
                  m_componentName.c_str());
      omx_err = OMX_ErrorTimeout;
      break;
    }
...
OMX_ERRORTYPE COMXCoreComponent::AllocInputBuffers()
{
  ...
  CLog::Log(LOGDEBUG,
            "COMXCoreComponent::AllocInputBuffers component({}) - port({}), nBufferCountMin({}), "
            "nBufferCountActual({}), nBufferSize({}), nBufferAlignment({})",
            m_componentName.c_str(), GetInputPort(), portFormat.nBufferCountMin,
            portFormat.nBufferCountActual, portFormat.nBufferSize, portFormat.nBufferAlignment); // **KM** {:u} -> {}
  ...
  for (size_t i = 0; i < portFormat.nBufferCountActual; i++)
  {
    ...
    {
      CLog::Log(LOGERROR,
                "COMXCoreComponent::AllocInputBuffers component({}) - OMX_UseBuffer failed with "
                "omx_err(0x{:x})",
                m_componentName.c_str(), omx_err);
      return omx_err;
    }
...
OMX_ERRORTYPE COMXCoreComponent::AllocOutputBuffers()
{
  ...
  CLog::Log(LOGDEBUG,
            "COMXCoreComponent::AllocOutputBuffers component({}) - port({}), nBufferCountMin({}), "
            "nBufferCountActual({}), nBufferSize({}) nBufferAlignment({})",
  ...
  for (size_t i = 0; i < portFormat.nBufferCountActual; i++)
  {
    ...
    {
      CLog::Log(LOGERROR,
                "COMXCoreComponent::AllocOutputBuffers component({}) - OMX_UseBuffer failed with "
                "omx_err(0x{:x})",
                m_componentName.c_str(), omx_err);
      return omx_err;
    }
  ...
  for(i=0; i < 4; i++)
  {
    ...
    if(omx_err == OMX_ErrorNone) {
      ...
      for(j=0; j<ports.nPorts; j++)
      {
        ...
        if(omx_err != OMX_ErrorNone)
        {
          CLog::Log(LOGERROR, "COMXCoreComponent::DisableAllPorts - Error disable port {} on component {} omx_err(0x{:08x})",
...
OMX_ERRORTYPE COMXCoreComponent::AddEvent(OMX_EVENTTYPE eEvent, OMX_U32 nData1, OMX_U32 nData2)
{
  ...
  CLog::Log(LOGDEBUG,
            "COMXCoreComponent::AddEvent {} add event event.eEvent 0x{:08x} event.nData1 0x{:08x} "
            "event.nData2 {}",
...
{
#ifdef OMX_DEBUG_EVENTS
  CLog::Log(LOGDEBUG, "COMXCoreComponent::WaitForEvent {} wait event 0x{:08x}",
  ...
  while(true)
  {
...
#ifdef OMX_DEBUG_EVENTS
      CLog::Log(LOGDEBUG,
                "COMXCoreComponent::WaitForEvent {} inlist event event.eEvent 0x{:08x} event.nData1 "
                "0x{:08x} event.nData2 {}",
                m_componentName.c_str(), (int)event.eEvent, (int)event.nData1, (int)event.nData2);
#endif
...
#ifdef OMX_DEBUG_EVENTS
        CLog::Log(LOGDEBUG,
                  "COMXCoreComponent::WaitForEvent {} remove event event.eEvent 0x{:08x} "
                  "event.nData1 0x{:08x} event.nData2 {}",
                  m_componentName.c_str(), (int)event.eEvent, (int)event.nData1, (int)event.nData2);
#endif
    ...
    {
      if (timeout > 0)
        CLog::Log(LOGERROR, "COMXCoreComponent::WaitForEvent {} wait event 0x{:08x} timeout {}",
...
OMX_ERRORTYPE COMXCoreComponent::WaitForCommand(OMX_U32 command, OMX_U32 nData2, long timeout)
{
#ifdef OMX_DEBUG_EVENTS
  CLog::Log(LOGDEBUG,
            "COMXCoreComponent::WaitForCommand {} wait event.eEvent 0x{:08x} event.command 0x{:08x} "
            "event.nData2 {}",
  ...
  while(true)
  {
...
#ifdef OMX_DEBUG_EVENTS
      CLog::Log(LOGDEBUG,
                "COMXCoreComponent::WaitForCommand {} inlist event event.eEvent 0x{:08x} "
                "event.nData1 0x{:08x} event.nData2 {}",
                m_componentName.c_str(), (int)event.eEvent, (int)event.nData1, (int)event.nData2);
#endif
      if(event.eEvent == OMX_EventError && event.nData1 == (OMX_U32)OMX_ErrorSameState && event.nData2 == 1)
...
#ifdef OMX_DEBUG_EVENTS
        CLog::Log(LOGDEBUG,
                  "COMXCoreComponent::WaitForCommand {} remove event event.eEvent 0x{:08x} "
                  "event.nData1 0x{:08x} event.nData2 {}",
                  m_componentName.c_str(), (int)event.eEvent, (int)event.nData1, (int)event.nData2);
#endif
    ...
    if (retcode != 0) {
      CLog::Log(LOGERROR,
                "COMXCoreComponent::WaitForCommand {} wait timeout event.eEvent 0x{:08x} "
                "event.command 0x{:08x} event.nData2 {}",
                m_componentName.c_str(), (int)OMX_EventCmdComplete, (int)command, (int)nData2);
...
OMX_ERRORTYPE COMXCoreComponent::SetStateForComponent(OMX_STATETYPE state)
{
  ...
  if (omx_err != OMX_ErrorNone)
  {
    ...
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::SetStateForComponent - {} same state",
                m_componentName.c_str());
      omx_err = OMX_ErrorNone;
    }
    else
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::SetStateForComponent - {} failed with omx_err(0x{:x})",
                m_componentName.c_str(), omx_err);
    }
  }
  else
  {
    ...
    if (omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::WaitForCommand - {} failed with omx_err(0x{:x})",
                m_componentName.c_str(), omx_err);
    }
  }
  return omx_err;
...
OMX_ERRORTYPE COMXCoreComponent::SetParameter(OMX_INDEXTYPE paramIndex, OMX_PTR paramStruct)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::SetParameter - {} failed with omx_err(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
  return omx_err;
}
...
OMX_ERRORTYPE COMXCoreComponent::GetParameter(OMX_INDEXTYPE paramIndex, OMX_PTR paramStruct) const
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::GetParameter - {} failed with omx_err(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
  return omx_err;
}
...
OMX_ERRORTYPE COMXCoreComponent::SetConfig(OMX_INDEXTYPE configIndex, OMX_PTR configStruct)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::SetConfig - {} failed with omx_err(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
  return omx_err;
}
...
OMX_ERRORTYPE COMXCoreComponent::GetConfig(OMX_INDEXTYPE configIndex, OMX_PTR configStruct) const
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::GetConfig - {} failed with omx_err(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
  return omx_err;
}
...
OMX_ERRORTYPE COMXCoreComponent::SendCommand(OMX_COMMANDTYPE cmd, OMX_U32 cmdParam, OMX_PTR cmdParamData)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::SendCommand - {} failed with omx_err(0x{:x})",
              m_componentName.c_str(), omx_err);
  }
  return omx_err;
}
...
OMX_ERRORTYPE COMXCoreComponent::EnablePort(unsigned int port,  bool wait)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::EnablePort - Error get port {} status on component {} omx_err(0x{:08x})",
  ...
  if(portFormat.bEnabled == OMX_FALSE)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::EnablePort - Error enable port {} on component {} omx_err(0x{:08x})",
          port, m_componentName.c_str(), (int)omx_err);
        return omx_err;
    }
    else
...
OMX_ERRORTYPE COMXCoreComponent::DisablePort(unsigned int port, bool wait)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "COMXCoreComponent::DisablePort - Error get port {} status on component {} omx_err(0x{:08x})",
        port, m_componentName.c_str(), (int)omx_err);
  }
  ...
  if(portFormat.bEnabled == OMX_TRUE)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::DIsablePort - Error disable port {} on component {} omx_err(0x{:08x})",
          port, m_componentName.c_str(), (int)omx_err);
      return omx_err;
    }
    else
...
OMX_ERRORTYPE COMXCoreComponent::UseEGLImage(OMX_BUFFERHEADERTYPE** ppBufferHdr, OMX_U32 nPortIndex, OMX_PTR pAppPrivate, void* eglImage)
{
  ...
  if(omx_err != OMX_ErrorNone)
  {
    CLog::Log(LOGERROR, "{}::{} - {} EnablePort failed with omx_err(0x{:x})", CLASSNAME, __func__,
              m_componentName.c_str(), omx_err);
    return omx_err;
  }
  ...
  {
    CLog::Log(LOGERROR, "{}::{} - {} nBufferCountActual unexpected {}", CLASSNAME, __func__,
              m_componentName.c_str(), portFormat.nBufferCountActual);
    return omx_err;
  }

  CLog::Log(LOGDEBUG,
            "{}::{} component({}) - port({}), nBufferCountMin({}), nBufferCountActual({}), "
            "nBufferSize({}) nBufferAlignment({})",
  ...
  for (size_t i = 0; i < portFormat.nBufferCountActual; i++)
  {
    ...
    if(omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "{}::{} - {} failed with omx_err(0x{:x})", CLASSNAME, __func__,
                m_componentName.c_str(), omx_err);
      return omx_err;
    }
...
bool COMXCoreComponent::Initialize( const std::string &component_name, OMX_INDEXTYPE index)
{
  ...
  if(!m_handle)
  {
    ...
    if (!m_handle || omx_err != OMX_ErrorNone)
    {
      CLog::Log(
          LOGERROR,
          "COMXCoreComponent::Initialize - could not get component handle for {} omx_err(0x{:08x})",
  ...
  if (omx_err != OMX_ErrorNone)
  {
    CLog::Log(
        LOGERROR,
        "COMXCoreComponent::Initialize - could not get port_param for component {} omx_err(0x{:08x})",
        component_name.c_str(), (int)omx_err);
  }
  ...
  {
    CLog::Log(LOGERROR,
              "COMXCoreComponent::Initialize - error disable ports on component {} omx_err(0x{:08x})",
              component_name.c_str(), (int)omx_err);
  }
  ...
  CLog::Log(LOGDEBUG, "COMXCoreComponent::Initialize {} input port {} output port {} m_handle {:p}",
...
bool COMXCoreComponent::Deinitialize()
{
  ...
  if(m_handle)
  {
    ...
    CLog::Log(LOGDEBUG, "COMXCoreComponent::Deinitialize : {} handle {:p}", m_componentName.c_str(),
              m_handle);
    omx_err = m_DllOMX->OMX_FreeHandle(m_handle);
    if (omx_err != OMX_ErrorNone)
    {
      CLog::Log(LOGERROR, "COMXCoreComponent::Deinitialize - failed to free handle for component {} omx_err(0x{:08x})",
          m_componentName.c_str(), omx_err);
    }
    m_handle = NULL;
...
OMX_ERRORTYPE COMXCoreComponent::DecoderEmptyBufferDone(OMX_HANDLETYPE hComponent, OMX_BUFFERHEADERTYPE* pBuffer)
{
  ...
  #if defined(OMX_DEBUG_EVENTHANDLER)
  CLog::Log(LOGDEBUG, "COMXCoreComponent::DecoderEmptyBufferDone component({}) {:p} {}/{}",
...
OMX_ERRORTYPE COMXCoreComponent::DecoderFillBufferDone(OMX_HANDLETYPE hComponent, OMX_BUFFERHEADERTYPE* pBuffer)
{
  ...
  #if defined(OMX_DEBUG_EVENTHANDLER)
  CLog::Log(LOGDEBUG, "COMXCoreComponent::DecoderFillBufferDone component({}) {:p} {}/{}",
  ...
  OMX_PTR pEventData)
{
#ifdef OMX_DEBUG_EVENTS
  CLog::Log(LOGDEBUG,
    "COMXCoreComponent::{} - {} eEvent(0x{:x}), nData1(0x{:x}), nData2(0x{:x}), pEventData(0x{:p})\n",
  ...
  {
    CLog::Log(LOGDEBUG,
      "COMXCoreComponent::{} - {} Ignoring expected event: eEvent(0x{:x}), nData1(0x{:x}), nData2(0x{:x}), pEventData(0x{:p})\n",
      __func__, GetName().c_str(), eEvent, nData1, nData2, pEventData);
    m_ignore_error = OMX_ErrorNone;
    return OMX_ErrorNone;
  }
  ...
  switch (eEvent)
  {
      ...
      switch(nData1)
      {
        case OMX_CommandStateSet:
          switch ((int)nData2)
          {
            ...
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StateInvalid", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            case OMX_StateLoaded:
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StateLoaded", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            case OMX_StateIdle:
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StateIdle", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            case OMX_StateExecuting:
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StateExecuting", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            case OMX_StatePause:
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StatePause", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            case OMX_StateWaitForResources:
            #if defined(OMX_DEBUG_EVENTHANDLER)
              CLog::Log(LOGDEBUG, "{}::{} {} - OMX_StateWaitForResources", CLASSNAME, __func__,
                        GetName().c_str());
#endif
            break;
            default:
        ...
        case OMX_CommandFlush:
          #if defined(OMX_DEBUG_EVENTHANDLER)
          CLog::Log(LOGDEBUG, "{}::{} {} - OMX_CommandFlush, port {}", CLASSNAME, __func__,
                    GetName().c_str(), (int)nData2);
#endif
        break;
        case OMX_CommandPortDisable:
          #if defined(OMX_DEBUG_EVENTHANDLER)
          CLog::Log(LOGDEBUG, "{}::{} {} - OMX_CommandPortDisable, nData1(0x{:x}), port {}",
                    CLASSNAME, __func__, GetName().c_str(), nData1, (int)nData2);
#endif
        break;
        case OMX_CommandPortEnable:
          #if defined(OMX_DEBUG_EVENTHANDLER)
          CLog::Log(LOGDEBUG, "{}::{} {} - OMX_CommandPortEnable, nData1(0x{:x}), port {}", CLASSNAME,
                    __func__, GetName().c_str(), nData1, (int)nData2);
#endif
        break;
        #if defined(OMX_DEBUG_EVENTHANDLER)
        case OMX_CommandMarkBuffer:
          CLog::Log(LOGDEBUG, "{}::{} {} - OMX_CommandMarkBuffer, nData1(0x{:x}), port {}", CLASSNAME,
                    __func__, GetName().c_str(), nData1, (int)nData2);
          break;
        #endif
      }
    ...
    case OMX_EventBufferFlag:
      #if defined(OMX_DEBUG_EVENTHANDLER)
      CLog::Log(LOGDEBUG, "{}::{} {} - OMX_EventBufferFlag(input)", CLASSNAME, __func__,
                GetName().c_str());
#endif
    ...
    case OMX_EventPortSettingsChanged:
      #if defined(OMX_DEBUG_EVENTHANDLER)
      CLog::Log(LOGDEBUG, "{}::{} {} - OMX_EventPortSettingsChanged(output)", CLASSNAME, __func__,
                GetName().c_str());
#endif
    break;
    case OMX_EventParamOrConfigChanged:
      #if defined(OMX_DEBUG_EVENTHANDLER)
      CLog::Log(LOGDEBUG, "{}::{} {} - OMX_EventParamOrConfigChanged(output)", CLASSNAME, __func__,
                GetName().c_str());
#endif
    break;
    #if defined(OMX_DEBUG_EVENTHANDLER)
    case OMX_EventMark:
      CLog::Log(LOGDEBUG, "{}::{} {} - OMX_EventMark", CLASSNAME, __func__, GetName().c_str());
      break;
    case OMX_EventResourcesAcquired:
      CLog::Log(LOGDEBUG, "{}::{} {}- OMX_EventResourcesAcquired", CLASSNAME, __func__,
                GetName().c_str());
      break;
    #endif
    case OMX_EventError:
      switch((OMX_S32)nData1)
      {
        case OMX_ErrorSameState:
          //#if defined(OMX_DEBUG_EVENTHANDLER)
          //CLog::Log(LOGERROR, "{}::{} {} - OMX_ErrorSameState, same state", CLASSNAME, __func__, GetName().c_str());
          //#endif
          break;
        case OMX_ErrorInsufficientResources:
          CLog::Log(LOGERROR, "{}::{} {} - OMX_ErrorInsufficientResources, insufficient resources",
                    CLASSNAME, __func__, GetName().c_str());
          m_resource_error = true;
        break;
        case OMX_ErrorFormatNotDetected:
          CLog::Log(LOGERROR, "{}::{} {} - OMX_ErrorFormatNotDetected, cannot parse input stream",
                    CLASSNAME, __func__, GetName().c_str());
          break;
        case OMX_ErrorPortUnpopulated:
          CLog::Log(LOGWARNING, "{}::{} {} - OMX_ErrorPortUnpopulated port {}", CLASSNAME, __func__,
                    GetName().c_str(), (int)nData2);
          break;
        case OMX_ErrorStreamCorrupt:
          CLog::Log(LOGERROR, "{}::{} {} - OMX_ErrorStreamCorrupt, Bitstream corrupt", CLASSNAME,
                    __func__, GetName().c_str());
          m_resource_error = true;
        break;
        case OMX_ErrorUnsupportedSetting:
          CLog::Log(LOGERROR, "{}::{} {} - OMX_ErrorUnsupportedSetting, unsupported setting",
                    CLASSNAME, __func__, GetName().c_str());
          break;
        default:
          CLog::Log(LOGERROR, "{}::{} {} - OMX_EventError detected, nData1(0x{:x}), port {}",
                    CLASSNAME, __func__, GetName().c_str(), nData1, (int)nData2);
          break;
      }
      // wake things up
    ...
    break;
    default:
      CLog::Log(LOGWARNING, "{}::{} {} - Unknown eEvent(0x{:x}), nData1(0x{:x}), port {}", CLASSNAME,
